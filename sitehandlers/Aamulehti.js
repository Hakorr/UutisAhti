...
let site = "Aamulehti";
let apiSearchURL = searchTerm => `https://www.aamulehti.fi/api/search/${encodeURIComponent(searchTerm)}/kaikki/whenever/new/0/${Settings.config.searchResultLimit}/0/${Date.now()}`;
let articleURL = href => `https://www.aamulehti.fi${href}`;

...
let site = "Satakunnan Kansa";
let apiSearchURL = searchTerm => `https://www.satakunnankansa.fi/api/search/${encodeURIComponent(searchTerm)}/kaikki/whenever/new/0/${Settings.config.searchResultLimit}/0/${Date.now()}`;
let articleURL = href => `https://www.satakunnankansa.fi${href}`;

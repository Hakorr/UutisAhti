...
let site = "Ilta-Sanomat";
let apiSearchURL = searchTerm => `https://www.is.fi/api/search/${encodeURIComponent(searchTerm)}/kaikki/whenever/new/0/${Settings.config.searchResultLimit}/0/${Date.now()}`;
let articleURL = href => `https://www.is.fi${href}`;
